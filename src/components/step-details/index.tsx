...
const StepDetails = (props: I_Props) => {
  ...
  const { dinningRoom, greatRoom, kitchen, mudRoom, ownersBath, ownersSuit } =
    selectDataToDisplay();

  console.log("dinningRoom", {
    dinningRoom,
    greatRoom,
    kitchen,
    mudRoom,
