    ...
    <div className="w-full max-w-[348px] ml-9 relative step-detail-container">
      ...
      <div className="w-full rounded-[20px] pt-2 pb-2.5 pl-4 pr-[15px] mb-[23px] bg-white stepper-detail-dropdown-open completed">
        ...
        <div className="mt-4 pl-5">
          ...
          <div className="inline-flex items-center">
            <div className={ `w-4 h-4 rounded-full p-1 ${selectedKitchenType.kitchen_layout ? 'bg-green-500' : 'bg-gray-400'}`}>
              <span className="block w-full h-full rounded-full bg-white"></span>
          ...
          <div className="flex items-center">
            <div className={ `w-4 h-4 rounded-full p-1 ${selectedKitchenType.cabinet_selection ? 'bg-green-500' : 'bg-gray-400'}`}>
              <span className="block w-full h-full rounded-full bg-white"></span>
            </div>
          ...
          <div className="flex items-center">
            <div className={ `w-4 h-4 rounded-full p-1 ${selectedKitchenType.counterTop_selection ? 'bg-green-500' : 'bg-gray-400'}`}>
              <span className="block w-full h-full rounded-full bg-white"></span>
            </div>
          ...
          <div className="flex items-center">
            <div className={`w-4 h-4 rounded-full  p-1 ${selectedKitchenType.plumbing_fixture ? 'bg-green-500' : 'bg-gray-400'}`}>
              <span className="block w-full h-full rounded-full bg-white"></span>
            </div>
      ...
      <div className="w-full rounded-[20px] pt-2 pb-2.5 pl-4 pr-[15px] mb-[23px] bg-white stepper-detail-dropdown-open completed">
        <div className="flex items-center">
          ...
          <p className="w-[calc(100%-113px)] pl-4 pr-2 text-lg font-medium leading-[30px] text-primary-100 mb-0">Owners Suite</p>
          <div className="flex items-center gap-[11px]">
            <button type="button">
      ...
      <div className="w-full rounded-[20px] pt-2 pb-2.5 pl-4 pr-[15px] mb-[23px] bg-white stepper-detail-dropdown-open completed">
        <div className="flex items-center">
          ...
          <p className="w-[calc(100%-113px)] pl-4 pr-2 text-lg font-medium leading-[30px] text-primary-100 mb-0">Owners Bath</p>
          <div className="flex items-center gap-[11px]">
            <button type="button">
              <svg width="23" height="20" viewBox="0 0 23 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M22.0548 11.9375L23 11.0625L20.1644 8V0H0V20H20.1644V13.875H18.9041V18.75H10.2082V16.4375H8.94794V18.75H1.26027V9.8125H8.94794V12.4375H10.2082V8.5625H1.26027V1.25H18.9041V4.5H15.1233V5.75H18.9041V8.4375L22.0548 11.9375Z" fill="#495057"/>
